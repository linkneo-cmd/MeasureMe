<template>
  <div class="home-container" @touchstart="handleTouchStart" @touchmove="handleTouchMove" @touchend="handleTouchEnd">
    <div class="search-section">
      ...
      <div class="category-tags" v-if="allCategories.length > 0">
        <div class="category-tags-inner">
          <van-tag type="default" :class="['category-tag tag-all', { 'category-tag-active': selectedCategory === '' }]" @click="filterByCategory('')">全部</van-tag>
          <van-tag
            v-for="cat in displayCategories"
            :key="cat"
            :class="['category-tag', `tag-${getCategoryColorIndex(cat)}`, { 'category-tag-active': selectedCategory === cat }]"
